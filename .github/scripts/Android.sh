...
# SDL
ARGS=( -G "Ninja" -DSDL_SHARED=ON -DSDL_STATIC=OFF -DSDL_ANDROID_JAR=OFF -DCMAKE_TOOLCHAIN_FILE="$ANDROID_NDK" -DANDROID_PLATFORM=android-$ANDROID_TARGET -DANDROID_ABI="$CPU" -DCMAKE_SHARED_LINKER_FLAGS="-Wl,-z,max-page-size=16384" -DCMAKE_EXE_LINKER_FLAGS="-Wl,-z,max-page-size=16384")
